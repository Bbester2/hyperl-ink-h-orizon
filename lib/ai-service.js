...
const SANITIZED_KEY = RAW_KEY.replace(/['"\s]/g, ''); // Remove quotes/spaces
const GEMINI_API_KEY = SANITIZED_KEY.length > 10 ? SANITIZED_KEY : 'AIzaSyBPQa6PqYxAWYNNVlA-H3-Zggw5iGins-k';
